		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Json Data",
									"targetURL": "#myapppro03jsondata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myapppro03jsondata-display": {
								"semanticObject": "myapppro03jsondata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=my.app.pro03jsondata",
									"url": sap.ui.require.toUrl("my/app/pro03jsondata")
								}
							}
						}
					}
